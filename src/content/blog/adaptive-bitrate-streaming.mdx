...
import howItWorks1Img from '@assets/img/how-it-works-1.png';
import howItWorks2Img from '@assets/img/how-it-works-2.png';
...
<img src={youtubeImg} alt="YouTube" loading="lazy" />
...
<img src={howItWorks1Img} alt="How it works 1" loading="lazy" />
...
<img src={howItWorks2Img} alt="How it works 2" loading="lazy" />
